...
match priority:
    case "high":
        if time_bound == "yes":
            ...
            print(f"Reminder: {task} is a high priority task that doesn't require immediate attention.")
        else:
            print("Invalid input")
    case "medium":
        if time_bound == "yes":
    ...
    case "low":
        if time_bound == "yes":
            ...
            print(f"Reminder: {task} is a low priority task that doesn't require immediate atttention")
        else:
            print("Invalid input")
    case _: 
        print("Invalid input")
